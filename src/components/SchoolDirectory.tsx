        ...
        {!loading && filtered.map(school => (
          ...
          >
            <div>
              ...
              <div style={{ display: "flex", gap: 14, fontSize: 12, color: c.textSecondary, marginBottom: 14, flexWrap: "wrap" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
                  <Users size={14} color={c.forest} />
                  <span><strong>{school.enrolledStudents}</strong> Enrolled</span>
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
                  <CheckCircle2 size={14} color={c.forest} />
                  <span><strong>{school.complianceRate}%</strong> Compliance</span>
                </div>
              </div>
            </div>
